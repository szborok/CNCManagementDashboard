...
export class SetupProcessor {
    ...
    const demoJsonFiles = [
      {
        ...
        data: {
          ...
          version: "",
          cadPart:
            "P:/Project/5270_Sumiriko_Pin_01_31406/CAM/W5270NS01_001/W5270NS01001.hmc",
          operator: "szborok",
      ...
      },
      {
        ...
        data: {
          ...
          version: "",
          cadPart:
            "P:/Project/5270_Sumiriko_Pin_01_31406/CAM/W5270NS01_003/W5270NS01003.hmc",
          operator: "szborok",
            ...
            violations: [
              {
                ...
                severity: "WARNING",
                message:
                  "Drilling depth of 25mm detected, consider optimization for depths over 60mm",
                location: "Operation 1 - T01 HSS Drill 8.5mm",
                suggestion:
                  "Consider using gun drill or pecking cycle for deeper holes",
              },
            ],
            optimizations: [
              {
      ...
      toolAnalysis: [
        {
          ...
          alerts: [
            ...
            },
            {
              ...
              message:
                "Roughing End Mill 16mm requires inspection after 500 hours",
              priority: "MEDIUM",
            },
          ],
        },
  ...
  private generateSampleData() {
    ...
    return {
      ...
      recentActivity: [
        {
          ...
          details:
            "Analysis completed - 4 rules applied (AutoCorrectionContour, M110Contour, GunDrill60MinLimit, SingleToolInNC), 1 warning found, 1 optimization suggested",
        },
        {
          id: 2,
          type: "json_analysis",
          ...
          details:
            "Analysis completed - 4 rules applied (AutoCorrectionPlane, M110Helical, ReconditionedTool, SingleToolInNC), 0 violations, 2 optimizations suggested",
        },
        {
          id: 3,
          type: "tool_inventory",
          ...
          details:
            "Excel inventory processed: 142 tools tracked, 2 low stock alerts (T05 Carbide Drill 12mm, T08 Roughing End Mill 16mm)",
        },
        {
          id: 4,
          ...
          details:
            "CP-002 Heavy Duty 500x400 in use for project W5270NS01001A - 5-Axis Milling setup active",
        },
      ],
      charts: {
        projectCompletion: [
      ...
      modules: {
        jsonScanner: {
          status: this.config.companyFeatures.jsonScanner
            ? "active"
            : "disabled",
          lastScan: this.config.companyFeatures.jsonScanner
            ? now.toISOString()
            : null,
          filesProcessed: this.config.companyFeatures.jsonScanner ? 2 : 0, // Matches demo files
        },
        toolManager: {
          status: this.config.companyFeatures.toolManager
            ? "active"
            : "disabled",
          lastUpdate: this.config.companyFeatures.toolManager
            ? now.toISOString()
            : null,
          toolsTracked: this.config.companyFeatures.toolManager ? 4 : 0, // Matches demo inventory
        },
        clampingPlateManager: {
          status: this.config.companyFeatures.clampingPlateManager
            ? "active"
            : "disabled",
          lastUpdate: this.config.companyFeatures.clampingPlateManager
            ? now.toISOString()
            : null,
          platesManaged: this.config.companyFeatures.clampingPlateManager
            ? 2
            : 0, // Matches demo plates
        },
      },
    };
  }
